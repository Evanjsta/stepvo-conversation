(() => {
  ...
  // js/client/highlight.js
  var highlightElementID = "live-debugger-highlight-element";
  var highlightPulseElementID = "live-debugger-highlight-pulse-element";
  ...
  function handleHighlight({ detail }) {
    ...
    if (highlightElement) {
      ...
      const toClear = detail.attr === void 0 || detail.val === void 0;
