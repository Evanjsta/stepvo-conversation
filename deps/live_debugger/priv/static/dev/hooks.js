...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  // js/hooks/collapsible_open.js
  var CollapsibleOpen = {
    mounted() {
      this.el.open = true;
    }
  };
  var collapsible_open_default = CollapsibleOpen;

  // js/hooks/fullscreen.js
  var Fullscreen = {
    mounted() {
      this.handleOpen = () => {
        this.el.showModal();
  ...
  var toggle_theme_default = ToggleTheme;
  ...
  var Tooltip = {
    mounted() {
      this.handleMouseEnter = () => {
        ...
        const topOffset = this.el.dataset.position == "top" ? rect.top - tooltipRect.height : rect.bottom;
  ...
  var live_dropdown_default = LiveDropdown;

  // js/hooks/auto_clear_flash.js
  var AutoClearFlash = {
    mounted() {
  ...
  var auto_clear_flash_default = AutoClearFlash;
  ...
  function createHooks() {
    return {
      CollapsibleOpen: collapsible_open_default,
      Fullscreen: fullscreen_default,
      Tooltip: tooltip_default,
      ToggleTheme: toggle_theme_default,
      Highlight: highlight_default,
      LiveDropdown: live_dropdown_default,
      AutoClearFlash: auto_clear_flash_default
    };
  }
